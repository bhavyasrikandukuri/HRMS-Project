...
<html>
    ...
    <form id="sim" action="pcstatus" method="post">  
        ...
        Enter message:   <input style="width:400px;height:50px;" type="text" name="status" placeholder="Type project completion status" ><br/>  
        Select Date: <input type="datetime-local" id="datetime" name="datetime" required="">
